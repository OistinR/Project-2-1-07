...
def read_Data():
    with open("C:/Users/Oistín/Documents/Github/Project-2-1-07/core/src/trainingDataAll.csv", mode='r') as file:
...
def training():
    ...
    model = Sequential()
    model.add(Dense(units=400, activation= 'relu', input_dim = 38))
    ...
    model.fit(X,Y, epochs=50, batch_size=32)#batch = 5000 games for 100 epoch and 32 batch is 15min+
